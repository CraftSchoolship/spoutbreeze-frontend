// File: d:\spoutbreeze-craft\spoutbreeze-frontend\app\auth\youtube\callback\page.tsx
...
function YouTubeCallbackContent() {
  ...
  useEffect(() => {
    ...
    // Handle OAuth errors from YouTube/Google
    if (errorParam) {
      ...
      setTimeout(() => {
        router.push(
          "/settings?tab=integrations&youtube_error=" +
    ...
    if (code && state) {
      ...
      }/api/auth/youtube/callback?code=${encodeURIComponent(
        code
      ...
      setTimeout(() => {
        router.push(
          "/settings?tab=integrations&youtube_error=invalid_callback"
        );
      }, 2000);
    }
  }, [searchParams, router]);
